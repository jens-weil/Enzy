...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("DEBUG: POST /api/shares - incoming:", { 
      articleId, 
      platform, 
      userId, 
      userEmail: userEmail || "NOT_PROVIDED", 
      hasImage: !!articleImage,
      hasLink: !!platformLink 
    });
    ...
    if (userEmail) {
      ...
      console.log("DEBUG: Triggering email for", userEmail, "at URL:", verificationUrl);
      ...
      try {
        ...
        console.error("DEBUG: Critical failure in email pipeline:", err);
