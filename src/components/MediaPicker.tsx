  ...
  return (
    ...
    >
      ...
      <div className="bg-white dark:bg-slate-900 w-full max-w-6xl max-h-[90vh] rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden relative z-10 border border-white/10">
        ...
        {/* Header */}        <div className="bg-brand-dark px-8 py-6 relative z-[50] border-b border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-6 shrink-0">
